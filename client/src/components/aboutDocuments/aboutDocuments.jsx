                ...
                <Col lg={8}>
                    ...
                    <div className={classes.header}>
                        <h4>Устав образовательной организации</h4>
                            ...
                            <div className={classes.urlStyle}>
                                <a href={ process.env.REACT_APP_API_URL + 'pdf/founding_documents/Лицензия_на_осуществление_образовательной_деятельности.pdf'}>Серия 50Л01 №0008960 №77080 от 24.05.2017г. Лицензия действительна бессрочно</a>
                            </div>
                            <div className={classes.urlStyle}>
                                <a href={process.env.REACT_APP_API_URL + 'pdf/founding_documents/Выписка-из-реестра-лицензий.pdf'}>Выписка из реестра лицензий от 04.05.2023г</a>
                            </div>
                            <h4>Свидетельство о государственной аккредитации (с приложениями)</h4>
                            <div className={classes.urlStyle}>
                                <a href={ process.env.REACT_APP_API_URL + 'pdf/founding_documents/Свидетельство-об-аккредитации.pdf'}>Серия 50А01 №0000271 №4573 от 03.11.2020г. Свидетельство действует бессрочно</a>
                            </div>
